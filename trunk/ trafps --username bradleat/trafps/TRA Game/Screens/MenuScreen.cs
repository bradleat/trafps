...
namespace TRA_Game
{
    ...
    abstract class MenuScreen : GameScreen
    {
        ...
        protected void OptionsMenuEntrySelected(object sender, EventArgs e)
        {
            OptionsMenuEntrySelected();
        }

        protected void OptionsMenuEntrySelected()
        {
            //LoadingScreen.Load(ScreenManager, false, new OptionsScreen(null));
        }
